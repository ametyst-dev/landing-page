...
```
[DATETIME] [STEP_DONE] to: orchestrator — macro step N done. PR: {PR_URL}
```
...
Switch to orchestrator and run `/sprint-delegate` to review the PR and advance to the next step."
