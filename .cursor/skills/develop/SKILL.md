...
> "current-sprint.mdc not found. Cannot determine the active sprint folder. Open a Claude Code session in orchestrator and run sprint-planner to initialize a sprint."
