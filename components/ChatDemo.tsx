...
export const CHAT_DEMO_SCRIPT: ScriptLine[] = [
  ...
  { kind: "tool",   text: "⏺ calling exa.search   \"fintech founders Europe\"   €0.001" },
  { kind: "tool",   text: "⏺ calling apollo.enrich   +verified emails   €1.20" },
...
export default function ChatDemo() {
  ...
  return (
    <section id="chat-demo" className="pt-8 md:pt-12 pb-16 md:pb-24 px-8 md:px-16 lg:px-24 xl:px-32 bg-bg">
