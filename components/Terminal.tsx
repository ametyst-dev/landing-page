...
export default function Terminal({
  ...
  return (
    <div className={`rounded-xl overflow-hidden border border-term-line bg-term-bg text-term-fg font-mono text-left ${className}`}>
      <div className="flex items-center gap-3 border-b border-term-line px-4 py-2.5">
        ...
        {title && <span className="text-xs text-term-muted truncate">{title}</span>}
