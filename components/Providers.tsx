 ...
 * trimmed to the ones with a verified favicon in public/providers/<slug>.png
 * and to a count that fills the 4-column grid. No logo, no row. */
      ...
      <div className="max-w-6xl mx-auto">
        <div className="max-w-3xl mx-auto text-center mb-10 md:mb-12">
          ...
          <p className="font-body text-base md:text-lg text-fg/75 leading-relaxed text-balance">
            The providers your agents call through Ametyst, each one priced per call. Your agent picks, you set the limit.
          </p>
        </div>
